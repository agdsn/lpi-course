...
\begin{frame} 
  ...
  \begin{itemize}
  \item \co{-v -l -t} wirken in der Regel wie Schalter die eine Option aktivieren
  \item \co{--verbose --long --tree} sind die Langformen zur besseren Verständlichkeit  bei sehr vielen Optionen
  \end{itemize}
  \end{block}
...
\begin{frame}
	...
	\begin{itemize}
		\item um die 30 Befehle
		\item beeinflussen oft die Shell selbst
		\item sehr schnell
		\item z.B. \co{echo}, \co{kill}, ... 
	\end{itemize}
...
\item \co{set}  zeigt alle - \co{env} oder \co{export} nur exportierte
\end{itemize}
